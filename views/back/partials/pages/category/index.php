	...
	<div class="page-wrapper">
		...
		<div class="table-responsive">
			<div class='pull-right'>
				...
				</select> with record type <select name="" class="filter cmbType">
				<option value="">No Problem</option>
				<option value="produk">Product</option>
				<option value="artikel">Article</option></select> &nbsp; &nbsp;<button class="btn-ku btn-white btn-add" data-type='category'><i class="fa fa-plus ico"></i></button>
			</div>
			<div style="clear:both"></div>
			<br>
			<?php
